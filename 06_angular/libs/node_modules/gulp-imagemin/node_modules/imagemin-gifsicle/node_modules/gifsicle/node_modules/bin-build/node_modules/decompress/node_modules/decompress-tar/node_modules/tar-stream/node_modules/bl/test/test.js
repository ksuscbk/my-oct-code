...
!process.browser && tape('test stream', function (t) {
  var random = crypto.randomBytes(65534)
    ...
    , bl     = new BufferList(function (err, buf) {
        ...
        bl.pipe(fs.createWriteStream('/views/bl_test_rnd_out.dat'))
          .on('close', function () {
            var s = fs.createReadStream('/views/bl_test_rnd_out.dat')
  ...
  fs.writeFileSync('/views/bl_test_rnd.dat', random)
  fs.createReadStream('/views/bl_test_rnd.dat').pipe(bl)
})
